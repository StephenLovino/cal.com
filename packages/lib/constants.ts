...
export const APP_NAME = "TimePiece"; // process.env.NEXT_PUBLIC_APP_NAME || "Cal.com";
...
export const SENDER_NAME = "TimePiece"; // process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Cal.com";
export const EMAIL_FROM_NAME = "TimePiece"; // process.env.EMAIL_FROM_NAME || APP_NAME;
